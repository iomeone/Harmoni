...
//
////==============================================================================
//class MIDIEvents  : public juce::Component,
...
//    {
//    public:
//        IncomingMessageCallback (MIDIEvents* o, const juce::MidiMessage& m, const juce::String& s)
...
//        }
//
//        Component::SafePointer<MIDIEvents> owner;
...
//
//    //==============================================================================
//    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MIDIEvents)
//};
